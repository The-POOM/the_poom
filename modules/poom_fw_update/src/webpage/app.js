...
function getFileInfo() {
    ...
    if (fileInput.files.length > 0 && fileInput.files[0].name == "poom.bin") {
        ...
        fileInfo.innerHTML = "";
        fileInfo.style.opacity = 1;
        window.alert('Please select a "poom.bin" file');
    }
}
